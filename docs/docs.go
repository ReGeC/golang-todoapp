...
const docTemplate = `{
    ...
    "paths": {
        "/statistics": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "фильрация задач для статистики по id автора",
                        "name": "user_id",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    ...
                    "400": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_ReGeC_golang-todoapp_internal_core_transport_http_response.ErrorResponse"
                        }
                    },
                    "500": {
        ...
        "/tasks": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "фильрация задач по id автора",
                        "name": "user_id",
                        "in": "query"
                    },
                    {
        ...
        "/tasks/{id}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Успешно найденная задача",
                        "schema": {
        ...
        "/users/{id}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Успешно найденный пользователь",
                        "schema": {
    ...
    "definitions": {
        "github_com_ReGeC_golang-todoapp_internal_core_transport_http_response.ErrorResponse": {
            "type": "object",
            "properties": {
                "error": {
                    "type": "string",
        ...
        "internal_features_tasks_transport_http.CreateTaskResponse": {
            ...
            "properties": {
                ...
                "created_at": {
                    "type": "string",
                    "example": "2006-01-26T10:30:20.299941Z"
                },
                "description": {
                    "type": "string",
                    "example": "test_desc"
