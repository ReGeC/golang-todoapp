...
type CreateTaskRequest struct {
	Title 		string 	`json:"title" validate:"required,min=1,max=100"         example:"Test_title"`
	Description *string `json:"description" validate:"omitempty,min=1,max=100"  example:"test_desc"`
